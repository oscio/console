...
export type Vm = {
  ...
  // <slug> exposes ports 8080 (code-server), 7681 (xterm), and 6901
  // (vnc, desktop only) — pick the port for the surface you want. No
  // :80 mapping: a VM has no canonical "main" surface to default to.
  internalUrl: string
